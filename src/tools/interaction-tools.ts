...
export const logInteractionTool = new DynamicStructuredTool({
  ...
  schema: z.object({
    ...
    contactId: z.number().optional().describe('Specific contact ID (optional)'),
...
export const getInteractionHistoryTool = new DynamicStructuredTool({
  ...
  schema: z.object({
    ...
    limit: z.number().default(50).describe('Maximum number of interactions to return'),
...
export const analyzeSentimentTrendsTool = new DynamicStructuredTool({
  ...
  schema: z.object({
    supplierId: z.number().optional().describe('Analyze trends for specific supplier'),
    contactId: z.number().optional().describe('Analyze trends for specific contact'),
